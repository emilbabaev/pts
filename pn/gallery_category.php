			  ...
			  <a href="/pn/<?echo $page_url;?>.php" class="btn btn-danger">Отмена</a>
				...
				<?
					...
					if (isset($_POST['add_data']))
					{
						...
						VALUES (NULL ,  '".mysql_real_escape_string($_POST['name'])."',  '".mysql_real_escape_string($_POST['text'])."','".$url."', '".mysql_real_escape_string($_POST['title'])."', '".mysql_real_escape_string($_POST['description'])."', '".mysql_real_escape_string($_POST['keywords'])."');";

...
?>
			  ...
			  <form id="tab" action="/pn/<?echo $page_url;?>.php?page=<?echo $_GET['page'];?>" method="post"  enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
						<label>Фото</label>
						<p><img src="/images/news/<?echo $img;?>" width="300px;"></p>
			  ...
			  <a href="/pn/<?echo $page_url;?>.php" class="btn btn-danger">Отмена</a>
				...
				<?
					...
					if (isset($_POST['add_data']))
					{
						...
						VALUES (
						NULL ,  '".mysql_real_escape_string($_POST['name'])."', '".mysql_real_escape_string($_POST['text'])."', '".mysql_real_escape_string($_POST['about'])."', '".$img."', '".date('Y-m-d H:i:s')."','".$url."');";
		...
		<table class="table">
		  ...
		  ?>
			...
			<tr>
			  <td><?echo $id;?></td>
			  <td><img src="/images/news/<?echo $img;?>" style="width: 100px;"></td>
			  <td><?echo $name;?></td>
			  <td><?echo $date;?></td>
			 <td>

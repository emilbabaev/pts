		  ...
		  <div class="col-md-4">
			...
			<div id="myTabContent" class="tab-content">
			  ...
			  <form id="tab" action="/pn/<?echo $page_url;?>.php" method="post"  enctype="multipart/form-data">
				...
				<p><img src="/images/producer/<?echo $img;?>" width="300px;"></p>
			  ...
			  <a href="/pn/<?echo $page_url;?>.php" class="btn btn-danger">Отмена</a>
				...
				<?
					...
					if (isset($_POST['add_data']))
					{
						...
						VALUES (
						NULL ,  '".mysql_real_escape_string($_POST['name'])."', '".mysql_real_escape_string($_POST['text'])."', '".$url."', '".$img."', '".mysql_real_escape_string($_POST['title'])."', '".mysql_real_escape_string($_POST['description'])."', '".mysql_real_escape_string($_POST['keywords'])."');";
		...
		<table class="table">
		  ...
		  ?>
			...
			<tr>
			  <td><?echo $id;?></td>
			  <td><?echo $name;?></td>
			  <td><?if ($img != "") {?><img src="/images/producer/<?echo $img;?>" style="width: 50px;"><?}?></td>
